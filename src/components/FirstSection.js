    ...
    return (
        <section className="firstSectionWrapper">
            ...
            <div className="firstSectionContainer">
                ...
                <p className="firstSectionP">4 m2 från 429kr/månad</p>
            ...
            <div className="firstSectionContainer">
                ...
                <p className="firstSectionP">8 m2 från 829kr/månad</p>
            ...
            <div className="firstSectionContainer">
                ...
                <p className="firstSectionP">12 m2 från 1229kr/månad</p>
                <button onClick={handleToggleChange} value="12 m2 från 1229kr/månad" className="btn2">Boka Förråd</button>
            </div>
